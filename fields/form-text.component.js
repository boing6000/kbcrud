...
import { Component, forwardRef, Inject, Injector, Optional, ViewChild } from '@angular/core';
...
FormTextComponent.decorators = [
    { type: Component, args: [{
                ...
                providers: [
                    { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return FormTextComponent; }), multi: true }
                ],
            },] },
];
/** @nocollapse */
